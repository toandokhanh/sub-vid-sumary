    ...
    <br/>
      ...
      <div className="container" style={{ backgroundColor: '#f7f7f8', borderRadius: '20px', padding: '0 30px 30px 30px' }}>
        ...
        <h3 style={{ margin: '15px 0 -27px 0', textAlign: 'left' }}>Video summary generator</h3>
          ...
          Are you looking for an online and automated tool to create subtitles for your videos? If so, SubVidSumary's auto caption generator is just what you're looking for - It's powerful, flexible, easy to use and best of all, adding subtitles is completely free! With SubVidSumary, you can easily subtitle your videos. You can then either embed them in the video permanently (hardcoded subtitles) or if you want you can download them as separate subtitle files (SRT, VTT, TXT, etc.). Our automatic caption generator uses artificial intelligence to create near-perfect captions for you. It can perform multiple tasks at once, such as automatic captioning, recording, and speech recognition.
          </div>
          <div className="col-lg-6">
          Simply upload your video and SubVidSumary will convert the audio to text, allowing you to edit as needed, and easily add that recording to your video with a single click. Combined with our simple yet powerful video editor, SubVidSumary is the best place to make your videos more accessible to more people. Translate Subtitles - Need more than just English subtitles? Then use SubVidSumary's Subtitle Generator to translate your text from English to other languages and vice versa. From Arabic to Armenian, or Spanish to Swahili, this tool will help you discover and create great videos in the process. Upgrade to SubVidSumary PRO Package to experience automatic translation.
          </div>
        </div>
      </div>
      <div className="container" style={{ backgroundColor: '#f7f7f8', borderRadius: '20px', padding: '0 30px 30px 30px'}}>
      ...
      <div className="container" style={{ backgroundColor: '#f7f7f8', borderRadius: '20px', padding: '0 30px 30px 30px'}}>
        <div className="row g-5 align-items-center" style={{ marginTop: "60px" }}>
          ...
          Creating automatic captions is just the first step in your journey with SubVidSumary. SubVidSumary is a simple yet powerful online video editing platform. You can add progress bar, background music, stickers, filters, special effects and more. We built SubVidSumary so you can focus on creating great content without having to master complicated video editing software. Our video editor has been used and loved by creators, influencers, and marketers alike. Use SubVidSumary to expand your audience and increase engagement on popular social media platforms like Instagram, Facebook, Twitter, TikTok, LinkedIn and many more. Whether you're a beginner in video editing or a pro, SubVidSumary - an easy-to-use tool - will get the job done in minutes.
          </p>
